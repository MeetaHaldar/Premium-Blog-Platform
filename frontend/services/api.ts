...
export const paymentAPI = {
  createCheckoutSession: (data: { blogId: string }) => apiClient.post('/payments/create-checkout-session', data),
  verifySession: (data: { sessionId: string }) => apiClient.post('/payments/verify-session', data),
  getPaymentHistory: (params?: any) => apiClient.get('/payments/history', { params })
};
...
export const userAPI = {
  ...
  updateProfile: (data: { name?: string; email?: string }) => apiClient.put('/user/profile', data),
